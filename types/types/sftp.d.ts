...
/// <reference types="node" />
/// <reference types="node" />
import ssh2, { ClientChannel, ExecOptions } from 'ssh2';
...
declare class sftp {
    ...
    get(path: string, dst?: string | NodeJS.WritableStream, options?: sftp.TransferOptions): Promise<string | NodeJS.WritableStream | Buffer>;
    fastGet(remoteFilePath: string, localPath: string, options?: sftp.FastGetTransferOptions): Promise<string>;
    put(input: string | Buffer | NodeJS.ReadableStream, remoteFilePath: string, options?: sftp.TransferOptions): Promise<string>;
    ...
    append(input: Buffer | NodeJS.ReadableStream, remotePath: string, options?: sftp.WriteStreamOptions): Promise<string>;
